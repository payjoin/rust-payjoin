...
cargo llvm-cov --no-report --workspace --all-features --exclude payjoin-ffi --exclude payjoin-fuzz # exclude payjoin-ffi because bindings are tested in their native language and fuzz because these tests are not coverage worthy
