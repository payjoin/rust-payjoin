...
/// A valid v2 pj parameter with all three required fragment fields (EX1,
/// OH1, RK1). Without a bootstrapped default the fuzzer cannot construct
/// a checksummed bitcoin address or a valid bech32-encoded HPKE pubkey,
/// so it would never reach the v2-specific parsing paths.
const DEFAULT_QUERY: &str = "amount=1&pjos=0\
