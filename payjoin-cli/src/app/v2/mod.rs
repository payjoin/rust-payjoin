...
impl AppTrait for App {
    ...
    async fn history(&self) -> Result<()> {
        print_header();
        // FIXME: if replay fails, should the entire history be skipped?
        // FIXME: if session is expired the entire history command fails
        // Fixed here: https://github.com/payjoin/rust-payjoin/pull/1036
