...
impl Initialized {
    ...
    pub fn create_poll_request(&self, ohttp_relay: String) -> Result<RequestResponse, Error> {
        self.0
...
impl PayjoinProposal {
    ...
    pub fn create_post_request(&self, ohttp_relay: String) -> Result<RequestResponse, Error> {
