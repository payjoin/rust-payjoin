...
pub const ORIGINAL_PSBT: &str = include_str!("../fixtures/original-psbt.base64");

/// From the BIP-174 test vector
pub const INVALID_PSBT: &str = include_str!("../fixtures/invalid-psbt.base64");

/// From the BIP-78 test vector
pub const PAYJOIN_PROPOSAL: &str = include_str!("../fixtures/payjoin-proposal.base64");

/// From the BIP-78 test vector
pub const PAYJOIN_PROPOSAL_WITH_SENDER_INFO: &str =
    include_str!("../fixtures/payjoin-proposal-with-sender-info.base64");

/// Input contribution for the receiver, from the BIP78 test vector
pub const RECEIVER_INPUT_CONTRIBUTION: &str =
    include_str!("../fixtures/receiver-input-contribution.base64");
