...
impl UncheckedProposal {
    pub fn from_request(
        ...
        Ok(UncheckedProposal { proposal: Proposal { psbt, params } })
    }
}
...
mod tests {
    ...
    fn test_from_request() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let witness_utxo = proposal.proposal.psbt.inputs[0]
            .witness_utxo
            .as_ref()
        ...
        assert_eq!(proposal.proposal.params.v, Version::One);
        assert_eq!(
            proposal.proposal.params.additional_fee_contribution,
