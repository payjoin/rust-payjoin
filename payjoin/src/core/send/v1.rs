...
impl SenderBuilder {
    ...
    /// Create a SenderBuilder from component parts to mirror v2::SenderBuilder::from_parts
    ///
    /// This method allows constructing a v1 SenderBuilder using a v1::PjParam directly,
    /// rather than requiring a full PjUri.
    pub fn from_parts(
        psbt: Psbt,
        pj_param: &crate::uri::v1::PjParam,
        address: &Address,
