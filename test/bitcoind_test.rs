...
// use bitcoind::bitcoincore_rpc::bitcoin::consensus::encode::serialize_hex;
// use bitcoind::bitcoincore_rpc::bitcoincore_rpc_json::{AddressType, WalletProcessPsbtResult};
// use bitcoind::bitcoincore_rpc::RpcApi;
// use log::{debug, log_enabled, Level};
// use payjoin_ffi::receive::{Headers, UncheckedProposal};
// use payjoin_ffi::send::Request;
// use payjoin_ffi::transaction::{PartiallySignedTransaction, Transaction};
// use payjoin_ffi::uri::{Amount, Uri};
//
//
// #[test]
// fn integration_test() {
...
//         (Transaction::new(tx.serialize()).expect("Invalid payjoin_psbt tx")).clone().into();
